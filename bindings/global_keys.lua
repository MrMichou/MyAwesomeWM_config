...
awful.keyboard.append_global_keybindings({
	...
	awful.key({ modkey }, "x", helpers.toggle_silent_mode, {
...
awful.keyboard.append_global_keybindings({
	...
	awful.key({}, "XF86Launch4", system_controls.next_asusctl_profile, {
...
awful.keyboard.append_global_keybindings({
	...
	awful.key({ ctrl, shift, modkey }, "[", function()
...
awful.keyboard.append_global_keybindings({
	...
	awful.key({ modkey, shift }, "space", nil, {
